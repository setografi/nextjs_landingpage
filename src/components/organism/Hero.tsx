...
const Hero: FC<HeroProps> = ({}) => {
  const badges = [
    {
      title: "382M",
      subtitle: "Hotel Available",
      icon: <KosIcon className="w-12 h-12 xl:w-16 xl:h-16" />,
      className: "md:border-r md:pr-10 xl:pr-20 2xl:pr-32 border-[#353535]",
    },
    {
      title: "9/10",
      subtitle: "People Happy",
      icon: <PeopleHappyIcon className="w-12 h-12 xl:w-16 xl:h-16" />,
      className: "md:border-r md:pr-10 xl:pr-20 2xl:pr-32 border-[#353535]",
    },
    {
      title: "100%",
      subtitle: "High Security",
      icon: <SecurityIcon className="w-12 h-12 xl:w-16 xl:h-16" />,
      className: "md:border-r md:pr-10 xl:pr-20 2xl:pr-32 border-[#353535]",
    },
    {
      title: "183",
      subtitle: "Countries",
      icon: <CountriesIcon className="w-12 h-12 xl:w-16 xl:h-16" />,
      className: "md:pr-10 xl:pr-20 2xl:pr-32",
    },
  ];
      ...
      <div className="relative top-40 md:top-52 xl:top-64 2xl:top-72 z-10 px-4 lg:px-4 xl:px-20 w-full ">
        ...
        <form className="mt-12 flex flex-row xl:w-7/12 2xl:w-4/12">
          <input
            ...
            type="text"
          />
          <div className="2xl:w-3/12 bg-accentBlue-500 hover:bg-accentBlue-500/70 flex items-center justify-center rounded-e-[50px] font-semibold text-black text-lg xl:text-xl px-6 xl:px-10 py-4 xl:py-5">
